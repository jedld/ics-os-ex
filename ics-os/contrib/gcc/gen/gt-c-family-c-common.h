...
void
gt_ggc_mx_VEC_tree_gc_vec_gc (void *x_p)
{
  struct VEC_tree_gc_vec_gc * const x = (struct VEC_tree_gc_vec_gc *)x_p;
    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_11VEC_tree_gc ((*x).base.vec[i0]);
        }
      }
    }
}
...
void
gt_pch_nx_VEC_tree_gc_vec_gc (void *x_p)
{
  struct VEC_tree_gc_vec_gc * const x = (struct VEC_tree_gc_vec_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_18VEC_tree_gc_vec_gc, gt_ggc_e_18VEC_tree_gc_vec_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).prefix.num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_11VEC_tree_gc ((*x).base.vec[i0]);
        }
      }
    }
}
...
void
gt_pch_p_18VEC_tree_gc_vec_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_tree_gc_vec_gc * const x ATTRIBUTE_UNUSED = (struct VEC_tree_gc_vec_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).prefix.num);
    for (i0 = 0; i0 != l0; i0++) {
