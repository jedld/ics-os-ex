...
/* GMP 5.1.3's gmp.h uses bare `const` and omits these; MPFR 3.0.1 (and
   gmpxx) require them, so define them here (C and C++ map to the same word). */
#define __gmp_const      const
#define __gmp_unsigned   unsigned
...
#define __GMP_CC "host-gcc vs ICS-OS SDK"
#define __GMP_CFLAGS "-m64 -ffreestanding"
